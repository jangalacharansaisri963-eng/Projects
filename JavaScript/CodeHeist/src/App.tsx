  ...
  return (
    <div className="min-h-screen bg-black text-neutral-100 flex flex-col font-mono selection:bg-emerald-500 selection:text-black">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-3 sm:p-5 flex flex-col gap-4">
        ...
        {/* Navigation Tabs */}
        <div className="flex items-center gap-1.5 sm:gap-2 border-b border-neutral-800 pb-2 overflow-x-auto scrollbar-none">
          <button
            id="tab-terminal"
          ...
          >
            ...
            <span>TARGET NODES (levels.py)</span>
          </button>
          ...
          >
            ...
            <span>DARKNET SHOP (shop.py)</span>
          </button>
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-bold text-amber-400 hover:bg-neutral-900 transition-all whitespace-nowrap ml-auto"
          >
