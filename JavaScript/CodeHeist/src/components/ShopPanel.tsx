    ...
    <div id="shop-panel" className="space-y-4 font-mono">
      <div className="flex items-center justify-between">
        ...
        <div className="text-right">
          <span className="text-xs text-neutral-400">Available Funds: </span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
        {SHOP_ITEMS.map((item) => {
          ...
          return (
            <div
              key={item.id}
              className="p-4 rounded-xl bg-neutral-900/90 border border-neutral-800 flex flex-col justify-between hover:border-neutral-700 transition-all"
            >
              <div>
                <div className="flex items-start justify-between gap-3 mb-2">
                  ...
                  {!isMaxTier ? (
                    ...
                    <span className="text-xs font-bold text-emerald-400 px-2 py-1 rounded bg-emerald-500/10 border border-emerald-500/20 flex items-center gap-1">
